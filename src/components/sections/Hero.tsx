...
export default function Hero() {
    return (
        <Section className="grid grid-cols-1 xl:grid-cols-2 gap-4 mb-16">
                ...
                <div className="hidden xl:flex items-center justify-center h-full- w-full">
                    <div className="hidden xl:grid grid-cols-3 grid-rows-3 gap-2 w-full h-1/2 z-0 overflow-hidden place-content-center">
                ...
                <div className="col-span-2 flex flex-wrap justify-center xl:justify-between gap-8">
                    <Card className="p-4 max-w-96 bg-white/60">
                        <CardHeader className="flex items-center gap-4 p-2">
                            <div className="bg-primary-200 text-primary-400 p-2 rounded-full">
                                <ToothIcon></ToothIcon>    
                            </div>
